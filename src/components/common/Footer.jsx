...
const Footer = () => {
    return (
        <div className="w-full bg-secondary pt-10 md:pt-17.5   flex flex-col gap-5 sm:gap-10 md:gap-18.5">
                ...
                <div className="flex flex-col gap-5 sm:gap-8 lg:gap-5.5 w-full">
                    <div className="flex gap-4 md:gap-6 lg:gap-8 xl:gap-5.5 flex-col xl:flex-row w-full ">
                        <div className="flex flex-col gap-6 max-w-full lg:max-w-129.25 w-full ">
                            ...
                            <p className="leading-160 font-poppins text-off-white text-sm sm:text-base">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 xl:gap-12.5">
                            {FOOTER_DATA.map((item, index) => (
                                <div
                                    key={index}
                                    className="flex flex-col gap-3 xl:gap-4 font-poppins text-off-white "
                                >
                    ...
                    <div className="flex gap-4 sm:gap-8 items-center text-off-white">
                        ...
                        <div className="flex gap-2 sm:gap-4">
                            {FOOTER_SOCIAL_LINKS.map((item, index) => (
                                ...
                                >
                                    <Icons
                                        icon={item.svg}
                                        pathClass={"fill-off-white group-hover:fill-secondary"}
            ...
            <div className="border-t border-t-off-white py-5 flex justify-center items-center px-4 xl:px-0 text-center">
                <p className="text-off-white font-poppins leading-160 text-sm md:text-base">

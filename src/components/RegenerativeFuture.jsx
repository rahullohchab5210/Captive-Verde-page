  ...
  return (
      <div className='lg:my-35 md:my-25 max-md:mt-10 max-md:mb-20 max-[1350px]:mx-3'>
          <div className='max-w-285 mx-auto'>
              <div className="bg-[url('/assets/images/webp/regenerative-future.webp')] bg-cover bg-center bg-no-repeat rounded-3xl min-h-80 flex flex-col items-center justify-center text-center px-4 py-8">
                  ...
                  <p className='sm:max-w-156.25 max-w-full pt-4 pb-8 font-poppins font-normal sm:text-base text-sm leading-160 tracking-normal text-off-white'>Whether you’re an investor, Indigenous leader, or global partner, there’s a place for you at Captiva.</p>
